...
<div class="container p-5">
    <div class="row">
        ...
        <div class="col-md-4">
            <form method="post" action="{{ route('terrains.creer') }}">
                <div class="form-floating mb-3">
                    <input name="longueur" type="longueur" class="form-control" id="floatingInput" placeholder="Longueur">
                    <label for="floatingInput">Longueur</label>
                </div>
                <div class="form-floating">
                    <input name="largeur" type="largeur" class="form-control" id="floatingPassword" placeholder="Largeur">
